...
plot_pca_all1 <- plot_pca_all +
  ...
  theme_bw() + theme(legend.position = "bottom",  legend.box = "vertical", legend.box.just = "left", panel.grid.minor = element_blank(), panel.grid.major = element_blank())
...
```{r}
setwd("C:/Users/mmccaig/OneDrive - NRCan RNCan/Documents/GitHub/SpruceBudworm_Stream-Bioindicator-Assessment/")
